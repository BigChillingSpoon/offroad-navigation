...
/// </summary>
/// <param name="Waypoints">The ordered list of intermediate coordinates forming the loop skeleton. Does NOT include the closing return to <paramref name="Entrance"/> - callers that need a closed path append Entrance themselves.</param>
